...
/**
 * @fileOverview An AI agent that answers questions about the content of an uploaded document.
 *
 * - answerQuestions - A function that answers questions about the document.
...
const AnswerQuestionsInputSchema = z.object({
  ...
  documentContent: z.string().describe('The content of the document to answer questions about.'),
});
